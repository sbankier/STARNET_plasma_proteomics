...
grn <- fread("~/sean/INTRePID/STARNET/gene_expression/eigengenes/eigenproteins/GRN_correlated_eigenprotein_inGRN_n4.tsv", data.table=FALSE)
...
#export results
fwrite(all_df, "~/sean/INTRePID/STARNET/gene_expression/eigengenes/eigenproteins/GRN_correlated_eigenprotein_inGRN_trait_associations_n4.tsv", sep="\t")