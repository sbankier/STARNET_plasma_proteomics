...
#import protein expression and eigengenes
...
#output results
cor_lab.to_csv('~/sean/INTRePID/STARNET/gene_expression/eigengenes/Olink_cases_combined_adjusted_eigengene_correlations.tsv', sep='\t', index=None)